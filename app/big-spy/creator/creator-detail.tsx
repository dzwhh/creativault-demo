...
interface CreatorDetailProps {
  creator: Creator;
  onClose: () => void;
  initialPlatform?: 'tiktok' | 'youtube' | 'instagram';
}
...
export default function CreatorDetail({ creator, onClose, initialPlatform = 'tiktok' }: CreatorDetailProps) {
  const [activeTab, setActiveTab] = useState<'tiktok' | 'youtube' | 'instagram' | 'amazon'>(initialPlatform);
  ...
  // 根据初始平台决定是否显示 tab 切换
  const showPlatformTabs = initialPlatform === 'instagram';
        ...
        <NormalDetail title="Influencer Details" detailType="creator">
          <div className="h-full overflow-y-auto">
            <div className="p-6">
              ...
              {/* Tab Navigation - Platform Based - Only show for Instagram */}
              {showPlatformTabs && (
                <div className="mb-6">
